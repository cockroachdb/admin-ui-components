...
export const QUERY_BEGIN = "cockroachui/queries/QUERY_BEGIN";
export const QUERY_ERROR = "cockroachui/queries/QUERY_ERROR";
export const QUERY_COMPLETE = "cockroachui/queries/QUERY_COMPLETE";
