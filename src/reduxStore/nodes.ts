...
export const LivenessStatus =
  protos.cockroach.kv.kvserver.storagepb.NodeLivenessStatus;
export type NodeLivenessStatus = protos.cockroach.kv.kvserver.storagepb.NodeLivenessStatus;
export const MembershipStatus =
  cockroach.kv.kvserver.storagepb.MembershipStatus;
 ...
 */
export function livenessNomenclature(liveness: NodeLivenessStatus) {
  switch (liveness) {
...
export function sumNodeStats(
  ...
  livenessStatusByNodeID: { [id: string]: NodeLivenessStatus },
) {
  const result = {
    nodeCounts: {
      total: 0,
